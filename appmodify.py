...
# Validate age and symptoms
if age < 1:
    st.warning("Age must be greater than or equal to 1.")
else:
    # Input symptoms
    ...
    if len(selected_symptoms) >= 3 and st.button("Predict Disease"):
        ...
        # Button to fetch patient history

        # Get disease-specific diet info
        disease_info = get_diet_for_disease(predicted_disease)

        # Display predicted disease and diet information
        ...
        # Option to download patient report as PDF
